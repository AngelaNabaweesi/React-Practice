function Header(){
    return (
      <div>
        ...
        <p>Words and Music by Joel Houston Benjamin <br/>Hastings & Michael Fatkin</p><br />
        <p>© 2017 Hillsong Music Publishing CCLI: 7084123</p><br />
        <div className="div2">
          <div className="h1heading">VERSE 1</div>
          <p>God of creation<br/>
          There at the start<br/>
          Before the beginning of time<br/>
          With no point of reference<br/>
          You spoke to the dark<br/>
          And fleshed out the wonder of light</p><br />
  
          <div className="h1heading">CHORUS 1</div>
          <p>And as You speak<br/>
          ...
          If creation sings Your praises so will I</p><br/>
  
          <div className="h1heading">VERSE 2</div>
          <p>God of Your promise<br/>
          You don’t speak in vain<br/>
          No syllable empty or void<br/>
          For once You have spoken<br/>
          All nature and science<br/>
          Follow the sound of Your voice</p><br/>
  
          <div className="h1heading">CHORUS</div>
          <p>And as You speak<br/>
          ...
          If creation still obeys You so will I</p><br/>
  
          <div className="h1heading">BRIDGE</div>
          <p >If the stars were made to worship so will I<br/>
          ...
          Then we’ll sing again a hundred billion times</p><br/>
  
          <div className="h1heading">VERSE 3</div>
          ...
          Abandoned in darkness to die</p><br/>
  
          <div className="h1heading">CHORUS 3</div>
          <p>And as You speak<br/>
          ...
          If You gave Your life to love them so will I</p><br/>
  
          <div className="h1heading">TAG</div>
          <p>Like You would again a hundred billion times<br/>
          But what measure could amount to Your desire<br/>
          You’re the One who never leaves the one behind</p>
        </div>
      </div>
    )
  }
